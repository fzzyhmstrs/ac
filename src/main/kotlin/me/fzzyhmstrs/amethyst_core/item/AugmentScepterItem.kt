    ...
    SpellCasting, ScepterLike, Modifiable, ManaItem
{
    ...
    override fun use(world: World, user: PlayerEntity, hand: Hand): TypedActionResult<ItemStack> {
        ...
        val pairedAugments = AugmentHelper.getOrCreatePairedAugments(activeEnchantId, testEnchant,stack)
    ...
    override fun <T> serverUse(
        ...
        return ScepterHelper.castSpell(world,
            ProcessContext.EMPTY_CONTEXT,user,hand,stack,activeEnchantId,spell,pairedAugments,testLevel,this)
    }
