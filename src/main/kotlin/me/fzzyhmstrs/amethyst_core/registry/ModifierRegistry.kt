...
object ModifierRegistry {
    ...
    val LESSER_ATTUNED = AugmentModifier(Identifier(AC.MOD_ID,"lesser_attuned"), cooldownModifier = -7.5, rollToll = 4).withDescendant(ATTUNED)
    ...
    val LESSER_THRIFTY = AugmentModifier(Identifier(AC.MOD_ID,"lesser_thrifty"), manaCostModifier = -5.0, rollToll = 4).withDescendant(THRIFTY)
    ...
    val LESSER_REACH = AugmentModifier(Identifier("amethyst_imbuement","lesser_reach"), rollToll = 4).withDescendant(REACH).withRange(rangePercent = 8.0)
    ...
    val LESSER_ENDURING = AugmentModifier(Identifier("amethyst_imbuement","lesser_enduring"), rollToll = 4).withDescendant(ENDURING).withDuration(durationPercent = 15)
